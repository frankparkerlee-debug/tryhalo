...
export default function PricingCard({
  ...
  return (
    <div className="max-w-xl mx-auto">
      <div className="bg-white rounded-2xl border border-halo-gold/15 p-8 md:p-10 card-hover">
        ...
        <p className="text-sm text-halo-gold font-medium mb-1">
          ...
          <ul className="space-y-2.5">
            {includes.map((item, index) => (
              <li key={index} className="flex items-start gap-3">
                <span className="w-5 h-5 rounded-full border-[1.5px] border-halo-gold/40 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <Check className="w-3 h-3 text-halo-gold" />
                </span>
